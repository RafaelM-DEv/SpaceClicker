<template>
  <q-page class="q-pa-md">
    <h2>Política Privacidade</h2>
      <p>A sua privacidade é importante para nós. É política do SpaceClicker respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site <a href=www.spacecliker.com.br>SpaceClicker</a>, e outros sites que possuímos e operamos.</p>
    ...
    <h3>Compromisso do Usuário</h3>
      <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o SpaceClicker oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ul>
      ...
      <li>C Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do SpaceClicker, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ul>
